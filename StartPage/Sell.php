    ...
    <div class="Form">
        <form name="sellForm" onsubmit="return validateForm()" action="Sell.php" method="post" enctype="multipart/form-data">
            ...
            <label for="name_product">
                <p class="text" style="font-size: 110%;display: inline-block;">Enter the name of product :</p>
            </label>
            <input type="text" id="name_product" name="name_product">
            <p class="err_msg" style="font-size:80%;color:red" id="name_product_info"> </p>

            <label for="info_product">
                <p class="text" style="font-size: 110%;display: inline-block;">Give more information about product :</p>
            </label><br>
            ...
            <label for="type_product">
                <p class="text" style="font-size: 110%;display: inline-block;">Select type of the product :</p>
            </label>
            ...
            <label for="upload_product">
                <p class="text" style="font-size: 110%;display: inline-block;">Upload photo of product :</p>
            </label>
            ...
            <label for="date">
                <p class="text" style="font-size: 110%;display: inline-block;">Select date for auction:</p>
            </label>
            ...
            <label for="time_slot">
                <p class="text" style="font-size: 110%;display: inline-block;">Hour:</p>
            </label>
            ...
            <label for="time_slot">
                <p class="text" style="font-size: 110%;display: inline-block;">Minutes:</p>
            </label>
            ...
            <label>
                <p class="text" style="font-size: 110%;display: inline-block;">Enter the base price of product:</p>
            </label>
            <input type="number" name="base_id" id="base_id"><br>

            <label>
                <p class="text" style="font-size: 110%;display: inline-block;">Your Product key:</p>
            </label>
