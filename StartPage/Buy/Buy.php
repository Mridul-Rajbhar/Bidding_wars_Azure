    ...
    ?>
                <table align='center' border='1' cellspacing='0' cellpadding='3'>
                    ...
                    <tr>
                        ...
                        <td>
                            <font color=black><?php echo $row['Hours'] . ":" . $row['Minutes'] ?></font>
                        </td>
                        <td>
                        ...
                        <td>
                            <font color=black><?php echo "<form action=itemDetails.php><input name=id type=hidden value=" . $row['product_id'] . ">
                                            <button type=submit>View Details</button></form>" ?></font>
                        </td>
                    </tr>
        <?php
            }
