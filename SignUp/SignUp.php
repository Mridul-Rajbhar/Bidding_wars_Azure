...
<body>
    ...
    <div class="Form">
        ...
        <form name="SignUpForm" onsubmit="return validateForm()" method="post" action="SignUp.php">
            ...
            <label for="uname">
                <p class="text" style="font-size: 110%;display: inline-block;"></p>
            </label>
            <input type="text" id="uname" name="uname" placeholder="Username">
            <p class="err_msg" style="font-size:80%" id="uname_info"></p>

            <label for="fname">
                <p class="text" style="font-size: 110%;display: inline-block;"></p>
            </label>
            <input type="text" id="fname" name="fname" placeholder="First Name">
            <p class="err_msg" style="font-size:80%" id="fname_info"></p>

            <label for="mname">
                <p class="text" style="font-size: 110%;display: inline-block;"></p>
            </label>
            <input type="text" id="mname" name="mname" placeholder="Middle Name">
            <p class="err_msg" style="font-size:80%" id="mname_info"></p>

            <label for="lname">
                <p class="text" style="font-size: 110%;display: inline-block;"></p>
            </label>
            <input type="text" id="lname" name="lname" placeholder="Last Name">
            <p class="err_msg" style="font-size:80%" id="lname_info"></p>

            <label for="dob">
                <p class="text" style="font-size: 110%;display: inline-block;">Date of Birth:</p>
            </label>
            ...
            <label for="gender">
                <p class="text" style="font-size: 110%;display: inline-block;">Gender: </p>
            </label>
            ...
            <label for="state">
                <p class="text" style="font-size: 110%;display: inline-block;">State: </p>
            </label>
